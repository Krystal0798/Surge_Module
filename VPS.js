...
const getVPSInfo = new Promise((resolve, reject) => {
    let opts = {
      ...
      headers: {
        'Cookie': '_ga=GA1.3.382178952.1700617568; _gid=GA1.3.707338405.1701243877; _gat=1; WHMCSP8D3Nbb7msEy=22694vttqdp16m7drv3jpje71j; cf_clearance=Fhe1isgMOtXY1lQCFgNzN.2hcX_WXiq5UzLLuHpp7Ek-1701280006-0-1-80d14e7e.1a84ddd.d7d0119e-160.0.0; WHMCSAffiliateID=4007; G_ENABLED_IDPS=google',
