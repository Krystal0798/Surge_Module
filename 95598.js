    ...
    .finally(() => {
        ...
        if (panelParams.length > 0) {
            ...
            opts = {
                ...
                // dayNum // 预计可用天数
                // date // 截至日期
                title: surgePanelConfig?.title || '𝑺𝒕𝒂𝒕𝒆 𝑮𝒓𝒊𝒅 𝑪𝒐𝒓𝒑𝒐𝒓𝒂𝒕𝒊𝒐𝒏 𝒐𝒇 𝑪𝒉𝒊𝒏𝒂',
                content: panelContent,
                icon: surgePanelConfig?.icon || 'bolt.shield',
                'icon-color': surgePanelConfig && surgePanelConfig.hasOwnProperty('icon-color') ? surgePanelConfig['icon-color'] : '#228B22'
        }
